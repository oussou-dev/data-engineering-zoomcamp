...
![homework datasets](https://github.com/DataTalksClub/data-engineering-zoomcamp/blob/main/02-workflow-orchestration/images/homework.png?raw=true)
...
```
SELECT COUNT(*) 
FROM `kestra-sandbox-demo-495511.zoomcamp_project.yellow_tripdata`
...
```
SELECT COUNT(*)
FROM `kestra-sandbox-demo-495511.zoomcamp_project.green_tripdata`
